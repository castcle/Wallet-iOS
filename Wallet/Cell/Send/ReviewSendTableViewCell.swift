...
class ReviewSendTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var reviewSendLabel: UILabel!
    @IBOutlet weak var castLabel: UILabel!

    override func awakeFromNib() {
        super.awakeFromNib()
        self.reviewSendLabel.font = UIFont.asset(.regular, fontSize: .body)
        self.reviewSendLabel.textColor = UIColor.Asset.white
        self.castLabel.font = UIFont.asset(.regular, fontSize: .head3)
